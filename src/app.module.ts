...
@Module({
  imports: [
    TypeOrmModule.forRootAsync({
      ...
      useFactory: () => ({
        type: 'postgres',
        url: 'postgresql://Aldinonid:Yk0RF5paENrB@ep-steep-cloud-a1ogi14z-pooler.ap-southeast-1.aws.neon.tech/portfolio?sslmode=require&channel_binding=require',
        autoLoadEntities: true, // otomatis load entity
        synchronize: false,      // ❗ hanya untuk dev, jangan dipakai di production
        ssl: {
